...
pub static IdentifierType_VARIANTS: &[&str] = &[
    ...
    "CommitteeOnUniformSecuritiesIdentificationProcedures",
    "StockExchangeDailyOfficialList",
...
pub static VehicleWrapper_VARIANTS: &[&str] = &[
    ...
    "MutualFund",
    "UnitTrust",
    "SocieteInvestissementCapitalVariable",
...
pub static RateIndex_VARIANTS: &[&str] = &[
    ...
    "TokyoOvernightAverageRate",
    "SwissAverageRateOvernight",
    "ConsumerPriceIndex",
];
...
pub static Industry_VARIANTS: &[&str] = &[
    ...
    "HotelAndResortRealEstateInvestmentTrusts",
    "OfficeRealEstateInvestmentTrusts",
    "HealthCareRealEstateInvestmentTrusts",
    "ResidentialRealEstateInvestmentTrusts",
    "RetailRealEstateInvestmentTrusts",
    "SpecializedRealEstateInvestmentTrusts",
...
pub static SubIndustry_VARIANTS: &[&str] = &[
    ...
    "Reinsurance",
    "InformationTechnologyConsultingAndOtherServices",
    ...
    "OfficeRealEstateInvestmentTrusts",
    "HealthCareRealEstateInvestmentTrusts",
    "MultiFamilyResidentialRealEstateInvestmentTrusts",
    "SingleFamilyResidentialRealEstateInvestmentTrusts",
    "RetailRealEstateInvestmentTrusts",
    "OtherSpecializedRealEstateInvestmentTrusts",
    "SelfStorageRealEstateInvestmentTrusts",
    "TelecomTowerRealEstateInvestmentTrusts",
    "TimberRealEstateInvestmentTrusts",
    "DataCenterRealEstateInvestmentTrusts",
