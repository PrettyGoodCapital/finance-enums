...
@pytest.mark.parametrize(
    ...
    [
        ...
        (ClearingHouse, {"NSCC", "FICC", "OCC", "CME", "ICEClear", "LCH", "EurexClearing", "DTCC"}),
        (FailsReason, {"InsufficientSecurities", "InsufficientCash", "InstructionMismatch", "RegulatoryHold", "SystemIssue"}),
        (AllocationMethod, {"AveragePrice", "SpecificLot", "ProRata", "FIFO", "LIFO", "StepOut"}),
        (GiveUpType, {"None", "GiveUp", "GiveIn", "AveragePriceGiveUp", "ClearingGiveUp"}),
        (BenchmarkType, {"InterestRate", "EquityIndex", "FixedIncomeIndex", "CommodityIndex", "FXFixing", "InflationIndex", "CreditIndex"}),
