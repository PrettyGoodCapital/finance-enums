...
#define ENUM_TO_STRING(type)                                                                                           \
  ...
  inline std::string type##_to_repr(const type& typ) {                                                                 \
    return std::string(#type) + std::string("<") + type##_names[static_cast<int>(typ)] + std::string(">");             \
  }
...
#define PYBIND_ENUM_VALUE2(name, v1, v2) .value(#v1, name::v1).value(#v2, name::v2)

#define ENUM_NAMES3(name, v1, v2, v3) static const std::vector<str_t> name##_names = {#v1, #v2, #v3};
...
#define PYBIND_ENUM_VALUE3(name, v1, v2, v3) .value(#v1, name::v1).value(#v2, name::v2).value(#v3, name::v3)

#define ENUM_NAMES4(name, v1, v2, v3, v4) static const std::vector<str_t> name##_names = {#v1, #v2, #v3, #v4};
...
#define ENUM_NAMES5(name, v1, v2, v3, v4, v5) static const std::vector<str_t> name##_names = {#v1, #v2, #v3, #v4, #v5};
...
#define ENUM_NAMES74(                                                                                                  \
  ...
  static const std::vector<str_t> name##_names = {                                                                     \
    ...
    #v58, #v59, #v60, #v61, #v62, #v63, #v64, #v65, #v66, #v67, #v68, #v69, #v70, #v71, #v72, #v73, #v74};
#define ENUM_MAPPING74(                                                                                                \
  name, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15, v16, v17, v18, v19, v20, v21, v22, v23, v24, \
  v25, v26, v27, v28, v29, v30, v31, v32, v33, v34, v35, v36, v37, v38, v39, v40, v41, v42, v43, v44, v45, v46, v47,   \
  v48, v49, v50, v51, v52, v53, v54, v55, v56, v57, v58, v59, v60, v61, v62, v63, v64, v65, v66, v67, v68, v69, v70,   \
  v71, v72, v73, v74                                                                                                   \
